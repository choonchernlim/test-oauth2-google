 ...
 * @author Dave Syer
 */
// TODO drop this class and use Spring's DefaultUserAuthenticationConverter, then wire it CustomUserDetails to pull in custom user data
public class DefaultUserAuthenticationConverter extends org.springframework.security.oauth2.provider.token.DefaultUserAuthenticationConverter {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultUserAuthenticationConverter.class);
