...
public class GoogleLogoutHandler implements LogoutHandler {
    ...
    @Autowired
    public GoogleLogoutHandler(OAuth2RestOperations oAuth2RestTemplate,
                               @Value("${google.logout.url}") String logoutUrl) {
    ...
    public void logout(final HttpServletRequest request,
        ...
        final String url = String.format("%s?token=%s", logoutUrl, oAuth2RestTemplate.getAccessToken());
